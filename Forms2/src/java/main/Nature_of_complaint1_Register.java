...
public class Nature_of_complaint1_Register extends HttpServlet {
...
ArrayList[] arr={id,name10};
String[] dbcolname={"id","name10"};
String query="select * from Nature_of_complaint ";
JVC_JSP_Common.setlistfromdb(arr, dbcolname, query, url, username, password);
request.setAttribute("id",id);
request.setAttribute("name10",name10);
            request.getRequestDispatcher("Nature_of_complaint1_Register.jsp").forward(request, response);        }
    }
