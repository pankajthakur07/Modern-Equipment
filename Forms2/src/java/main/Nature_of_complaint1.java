...
public class Nature_of_complaint1 extends HttpServlet {
...
if(userName == null||userName.isEmpty()) response.sendRedirect("index.jsp");
   ...
   String[] dbcolname=new String[2];
    ...
    int i=1;
   String get_id="";
     String tablename="Nature_of_complaint";
 ...
 out.print("<script>alert('Data Save!');</script>");
             out.print("<script>window.location.href='/Forms2/Nature_of_complaint1_Register'</script>");
                    break outerloop;
                }
                count++;
            }
