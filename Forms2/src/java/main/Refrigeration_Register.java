...
public class Refrigeration_Register extends HttpServlet {
...
ArrayList[] arr={id,name5};
String[] dbcolname={"id","name5"};
String query="select * from Refrigeration ";
JVC_JSP_Common.setlistfromdb(arr, dbcolname, query, url, username, password);
request.setAttribute("id",id);
request.setAttribute("name5",name5);
            request.getRequestDispatcher("Refrigeration_Register.jsp").forward(request, response);        }
    }
