...
public class Mechanical_Register extends HttpServlet {
...
ArrayList[] arr={id,name4};
String[] dbcolname={"id","name4"};
String query="select * from Mechanical ";
JVC_JSP_Common.setlistfromdb(arr, dbcolname, query, url, username, password);
request.setAttribute("id",id);
request.setAttribute("name4",name4);
            request.getRequestDispatcher("Mechanical_Register.jsp").forward(request, response);        }
    }
