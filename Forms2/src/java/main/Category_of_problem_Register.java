...
public class Category_of_problem_Register extends HttpServlet {
...
String query="select * from Category_of_problem ";
JVC_JSP_Common.setlistfromdb(arr, dbcolname, query, url, username, password);
request.setAttribute("id",id);
request.setAttribute("name2",name2);
            request.getRequestDispatcher("Category_of_problem_Register.jsp").forward(request, response);        }
    }
