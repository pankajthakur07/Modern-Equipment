...
public class Refrigeration extends HttpServlet {
...
if(userName == null||userName.isEmpty()) response.sendRedirect("index.jsp");
   ...
   String[] dbcolname=new String[2];
    ...
    int i=1;
   String get_id="";
     String tablename="Refrigeration";
    if(ServletFileUpload.isMultipartContent(request)){
            ...
            while (true) {                
             ...
             out.print("<script>window.location.href='/Forms2/Refrigeration_Register'</script>");
                    break outerloop;
                }
                count++;
            }
