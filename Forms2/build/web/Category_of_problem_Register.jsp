...
%>
<input type="button" value="Add" name="btn" size="20" onclick="javascript:window.location.href='/Forms2/cop'"/>
...
<tr>
<td>
                <a href="alter_Category_of_problem?id=<%=idstr %>"> <%=idstr %></a>
             </td>
<td>
                 <%=name2str %>
             </td>
