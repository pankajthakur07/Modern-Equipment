...
public class Responsible_Engineer extends HttpServlet {
...
if(userName == null||userName.isEmpty()) response.sendRedirect("index.jsp");
   ...
   String[] dbcolname=new String[7];
    String[] dbvalues=new String[7];
    int i=1;
   String get_id="";
     String tablename="Responsible_Engineer";
...
//out.println(Result);
             ...
             out.print("<script>window.location.href='/Forms/Responsible_Engineer_Register'</script>");  
                    break outerloop;
                }
                count++;
            }
        }
                                        // request.getRequestDispatcher("Responsible_Engineer.jsp").forward(request, response);
