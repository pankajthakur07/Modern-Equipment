...
public class Equipment_master1_Register extends HttpServlet {
...
ArrayList[] arr={id,name6};
String[] dbcolname={"id","name6"};
String query="select * from Equipment_master ";
JVC_JSP_Common.setlistfromdb(arr, dbcolname, query, url, username, password);
request.setAttribute("id",id);
request.setAttribute("name6",name6);
            request.getRequestDispatcher("Equipment_master1_Register.jsp").forward(request, response);        }
    }
