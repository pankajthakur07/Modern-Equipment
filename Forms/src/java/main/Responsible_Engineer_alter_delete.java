 ...
 */
public class Responsible_Engineer_alter_delete extends HttpServlet {
...
if(userName == null||userName.isEmpty()) response.sendRedirect("index.jsp");
            ...
            String deletequery="delete from responsible_engineer where id='"+id1+"'";
            JVC_JSP_Common.insertupdateindbsilent(deletequery, url, username, password);
