...
public class Type_of_visit_Register extends HttpServlet {
...
ArrayList[] arr={id,name3};
String[] dbcolname={"id","name3"};
String query="select * from Type_of_visit ";
JVC_JSP_Common.setlistfromdb(arr, dbcolname, query, url, username, password);
request.setAttribute("id",id);
request.setAttribute("name3",name3);
            request.getRequestDispatcher("Type_of_visit_Register.jsp").forward(request, response);        }
    }
