...
public class Company_master extends HttpServlet {
   ...
   String get_id="";
    ...
    if(ServletFileUpload.isMultipartContent(request)){
            ...
            while (true) {                
             ...
             out.print("<script>window.location.href='/Forms/Company_master_Register'</script>");
                    break outerloop;
                }
                count++;
            }
