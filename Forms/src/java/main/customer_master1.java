...
public class customer_master1 extends HttpServlet {
...
if(userName == null||userName.isEmpty()) response.sendRedirect("index.jsp");
   ...
   String[] dbcolname=new String[17];
    String[] dbvalues=new String[17];
    int i=1;
   String get_id="";
     String tablename="customer_master";
    if(ServletFileUpload.isMultipartContent(request)){
            ...
            out.print("<script>window.location.href='/Forms/customer_master1_Register'</script>");
                    break outerloop;
                }
                count++;
            }
