...
public class Equipment_master1 extends HttpServlet {
...
if(userName == null||userName.isEmpty()) response.sendRedirect("index.jsp");
   ...
   String[] dbcolname=new String[2];
    ...
    int i=1;
   String get_id="";
     String tablename="Equipment_master";
    if(ServletFileUpload.isMultipartContent(request)){
            ...
            while (true) {                
             ...
             out.print("<script>window.location.href='/Forms/Equipment_master1_Register'</script>");
                    break outerloop;
                }
                count++;
            }
