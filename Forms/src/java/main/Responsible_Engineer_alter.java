...
public class Responsible_Engineer_alter extends HttpServlet {
...
ArrayList[] arr={id,name1,Email,Phone,User_name,User_password,type};
String[] dbcolname={"id","name1","Email","Phone","User_name","User_password","type"};
String query="select * from responsible_engineer where id='"+idtoalter+"' ";
...
request.setAttribute("type",type);
            request.getRequestDispatcher("Responsible_Engineer_alter.jsp").forward(request, response);        }
    }
