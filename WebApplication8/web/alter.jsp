...
%>
<form class="form-horizontal" id="myform" action="alter_save?id=<%=idarr.get(0).toString()%>" method="post" enctype="multipart/form-data">
...
<tr>
<td>Customer_name</td><td>
                 <input name="lead_name" type="text" value="<%=lead_namearr.get(0).toString() %>" placeholder="Customer_name" >
             </td>
</tr>
<tr>
<td>Model_number</td><td>
                 <input name="lead_source" type="text" value="<%=lead_sourcearr.get(0).toString() %>" placeholder="Model_number" >
             </td>
</tr>
<tr>
<td>Status</td><td>
                 <input name="lead_status" type="text" value="<%=lead_statusarr.get(0).toString() %>" placeholder="Status" >
             </td>
</tr>
<tr>
<td>Nature_of_complaint</td><td>
                 <input name="land_line" type="text" value="<%=land_linearr.get(0).toString() %>" placeholder="Nature_of_complaint" >
             </td>
</tr>
<tr>
<td>Category_of_problem</td><td>
                 <input name="mobile_no" type="text" value="<%=mobile_noarr.get(0).toString() %>" placeholder="Category_of_problem" >
             </td>
</tr>
<tr>
<td>Electrical</td><td>
                 <input name="email" type="text" value="<%=emailarr.get(0).toString() %>" placeholder="Electrical" >
             </td>
</tr>
<tr hidden>
<td>Date Of Birth</td>
...
<tr>
<td>Mechanical</td><td>
                 <input name="area" type="text" value="<%=areaarr.get(0).toString() %>" placeholder="Mechanical" >
             </td>
</tr>
<tr>
<td>Refrigeration</td><td>
                 <input name="intrest_type" type="text" value="<%=intrest_typearr.get(0).toString() %>" placeholder="Refrigeration" >
             </td>
</tr>
<tr hidden>
<td>Effort Date</td><td>
                 <input name="effort_date" type="text" value="<%=effort_datearr.get(0).toString() %>" placeholder="effort_date" >
             </td>
</tr>
<tr>
<td>Serial_number</td><td>
                 <input name="lead_owner" type="text" value="<%=lead_ownerarr.get(0).toString() %>" placeholder="Serial_number" >
             </td>
</tr>
<tr hidden>
<td>Time</td><td>
...
<tr>
<td>Assign</td><td>
                 <input name="tally_serial_number" type="text" value="<%=tally_serial_numberarr.get(0).toString() %>" placeholder="Assign" >
             </td>
</tr>
</tbody>
</table>
