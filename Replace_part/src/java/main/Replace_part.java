...
public class Replace_part extends HttpServlet {
   ...
   String[] dbcolname=new String[3];
    String[] dbvalues=new String[3];
    int i=1;
   String get_id="";
     String tablename="Replace_part";
    if(ServletFileUpload.isMultipartContent(request)){
     ...
     request.getRequestDispatcher("Replace_part.jsp").forward(request, response);  
        }
    }
